...
using NetCoreWebApiKafka.Application.Features.Positions.Commands.DeletePositionById;
using NetCoreWebApiKafka.Application.Features.Positions.Commands.UpdatePosition;
using NetCoreWebApiKafka.Application.Features.Positions.Queries.GetPositionById;
using NetCoreWebApiKafka.Application.Features.Positions.Queries.GetPositions;
using NetCoreWebApiKafka.WebApi.Extensions;
using System;
using System.Threading.Tasks;

// For more information on enabling Web API for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace NetCoreWebApiKafka.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
